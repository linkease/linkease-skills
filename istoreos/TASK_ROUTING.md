...
This profile hides implementation-oriented skills behind product-level user tasks.

| User says | Primary skill | Follow-up skills |
| --- | --- | --- |
...
| 不确定配置/源码行为 | `istoreos-source-introspect` | Owning domain skill |
